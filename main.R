...
write.csv(mean_all, file = "/data/out/files/mean_all.csv", row.names = FALSE)
write.csv(mean_male_survived, file = "/data/out/files/mean_male_survived.csv", row.names = FALSE)
